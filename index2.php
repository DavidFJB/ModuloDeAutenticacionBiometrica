...
<body>
  ...
  <script type="text/javascript">
    swal({title: 'Correcto',html: '<b>Iniciaste sesión correctamente</b>, muchas gracias por usar el modulo de autenticación biometrica', type: 'success',confirmButtonText: 'Aceptar'});
  </script>
